...
$stmt = $conn->prepare("SELECT * FROM client WHERE login= :username AND password = :password");
...
if ($result) {
    ...
    //username and password are true, proceed with login
    header("Location: index.php");
} else {
    ...
    <code>
        <?php echo $error ?? "" ; ?>
                            ...
                            <div class="col-lg-6 d-none d-lg-block ">
                                <img src="images/qrcodelogin.jpg" height="100%" width="100%"/>
                            </div>
